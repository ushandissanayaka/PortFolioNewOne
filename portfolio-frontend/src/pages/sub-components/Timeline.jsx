  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="w-full max-w-4xl p-4">
        <h1 className='text-[1.5rem] sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] mb-4 font-extrabold text-center'>
          Timeline
        </h1>
        <ol className="relative border-none sm:border-s border-gray-200 dark:border-gray-700">
          {timeline && timeline.map(element => (
            <li className="mb-10 ms-0 sm:ms-6 text-center sm:text-left" key={element._id}>
